...
namespace DotNetCoreSampleApi.Migrations
{
    ...
    [Migration("20200406054219_ForeignKeyDeletionRuleChanged")]
    partial class ForeignKeyDeletionRuleChanged
    {
            ...
            modelBuilder.Entity("DotNetCoreSampleApi.Domains.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("8400e3c2-f7e3-4dc1-8448-f30451b2db5d"),
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            RoleId = new Guid("5223f8f8-3ae0-437e-8327-b931f467d0cb"),
                            Name = "Customer",
